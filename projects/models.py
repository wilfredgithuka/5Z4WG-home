...
class Project(models.Model):
    ...
    # header_image = models.ImageField(upload_to='media/header_images/', blank=True)
    header_image = ResizedImageField(size=[1024, 300], crop=['top', 'left'], upload_to='media/images/', blank=True)
